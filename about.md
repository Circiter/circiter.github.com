...
raw %}{%{% endraw %} raw %}`. Сейчас я пытаюсь заставить формулы верстаться в общем контексте, 
чтобы можно было пользоваться штатными средствами $\mbox{\LaTeX}$'а для автоматической их 
нумерации.
