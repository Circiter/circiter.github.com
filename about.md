...
и здесь сразу же нашелся маленький плагин, решивший эту проблему (`kramdown_easy_link.rb`).
...
содержащий комманды записи некоторых параметров формулы (а именно её типографской <<глубины>>) во внешний
файл, содержимое которого используется для более корректного позиционирования готовых картинок на
html-странице.
