...
эры, а именно с работ фон Неймана по самореплицирующимся [клеточным] автоматам [9, 48] или даже 
с работ Черча и Хаскеля...
...
некотором его подмножестве может и не оказаться подобных средств (ещё раз подчеркну, это лишь 
усложнит написание квина, но не сделает его невозможным).
...
```
(Неплохое введение в написание квайнов можно найти, например, в [1, 30].)
