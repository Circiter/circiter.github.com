...
асимптотическая сложность равна $\sum_{p\in\mathbb{P}_{\leqslant n}} \frac{n}{p}$. 
Известно, что $\sum_{p\in\mathbb{P}_{\leqslant n}}\frac1p = \log\log n +\mathcal{O}(1)$. 
Таким образом, временна&#x301;я сложность решета Эратосфена оценивается как 
