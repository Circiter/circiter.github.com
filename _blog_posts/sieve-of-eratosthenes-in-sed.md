...
улучшения. Во-первых, можно игнорировать все числа $m\colon \forall p\in\mathbb{P}_{<h} 
\operatorname{\text{НОД}}(m, p)=1$ для выбранного числа $h\geqslant 2$; e.g., при $h=2$ это 
соответствует игнорированию всех чётных чисел, больших двух, всегда по-определению являющихся 
составными.

Во-вторых (хотя это очень похоже на первый пункт), перебор кратных для нечётных простых чисел 
$p$ можно вести с шагом $2p$, а не $p$.

В-третьих, процесс вычеркивания чисел, кратных очередному найденному простому $p$ можно начинать 
сразу с $p^2$, а не с $2p$.

В-четвертых, не имеет смысла продолжать вычеркивание кратных если $p^2>n$. Естественно, желающие 
могут добавить эти оптимизации в обсуждаемый скрипт (хотя с квадратами в sed, наверное, лучше не 
связываться).
