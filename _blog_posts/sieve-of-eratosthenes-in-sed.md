...
p\in\mathbb{P}_{\leqslant h}\ \operatorname{gcd}(m, p)=1$ для некоторого $h\geqslant 2$; 
...
каждой итерации, если $p=p_i$, то $\forall x\in L\ j<i\Rightarrow \operatorname{gcd}(x, 
...
$L=\{f\colon f\in[p; n], \forall q<p\ \operatorname{gcd}(q, f)=1\}$. Это совпадает с 
