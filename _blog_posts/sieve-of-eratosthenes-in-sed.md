...
p\in\mathbb{P}_{\leqslant h} (m\neq p) \land \operatorname{gcd}(m, p)=1$ для некоторого 
$h\geqslant 2$; e.g., при $h=2$ это соответствует игнорированию всех чётных чисел, больших двух, 
всегда по-определению являющихся составными.
...
Наконец, не имеет смысла продолжать вычеркивание кратных если $p^2>n$. (Естественно, желающие 
