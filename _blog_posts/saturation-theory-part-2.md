...
тысячи лет, намекает на некоторую подозрительность моего результата. Вероятностный аргумент 
Померанса так и вообще есть образчик неоднозначности типа <<стакан полон *versus* стакан пуст>> 
-- можно делать акцент на исчезающе малой вероятности, и делать вывод о несуществовании нечётных 
совершенных чисел (даже несмотря, ещё раз повторюсь, на потенциальную применимость этого 
аргумента к чётным совершенным числам при их явном существовании), а можно обратить внимание на 
не равенство этой верояности нулю и сделать вывод их возможном существовании. Таким образом, 
убедительной независимой поддержки верности или неверности моего доказательства мне найти не 
удалось. Но сам феномен насыщения не становится от этого менее интересным.
