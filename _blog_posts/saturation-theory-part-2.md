...
Померанса так и вовсе есть образчик неоднозначности типа <<стакан полон *versus* стакан пуст>> 
...
не равенство этой вероятности нулю и сделать вывод (противоположный, *sic*) о их возможном 
существовании. Таким образом, убедительной независимой поддержки верности или ошибочности моего 
доказательства мне найти не удалось. Но сам феномен насыщения не становится от этого менее 
интересным.
...
возведения в *ненулевую* степень --- cf. $\eqref{eq:phi-ineq}$ --- получится целое число, 
большее единицы и делящееся на $\mu_j$ (т.к. $j\neq h$). Это приводит к целочисленности 
подвыражения $\text{II}$.
