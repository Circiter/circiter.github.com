...
GNU в Posix и смогло ли бы это решить проблему портабельности? Ближайшие по смыслу найденные 
мною проекты -- <http://lvogel.free.fr/sed/sedcheck.sed> за авторством [Laurent 
Vogel](http://lvogel.free.fr), проверяющий скрипты на Posix-совместимость; и транслятор 
<https://github.com/lhoursquentin/sed-bin>, конвертирующий sed в C (примечательно, что оба 
проекта сами являются sed-скриптами).
