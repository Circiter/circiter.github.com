...
регулярному выражению-шаблону. Уже лишь эта комманда, могущая показаться далёкой по своей функциональности
от обеспечения Тьюринг-полноты входного языка sed, всё же делает данный редактор вычислительно-универсальной
реализацией [нормальных алгорифмов Маркова][nma] и, вместе с <<синтаксическим сахаром>> вроде меток
и комманд перехода (условных и безусловных), обуславливает саму возможность всех произошедших с sed
приключений [с его нестандартным использованием].
...
[отдельном сообщении](http://circiter.github.io/blog_posts/computus-in-sed).
...
* <https://github.com/mame/quine-relay> -- тоже почти квин (авторы: [Yusuke Endoh](https://github.com/mame),
   даже написавший [книжку](http://gihyo.jp/book/2015/978-4-7741-7643-7), на японском, об эзотерическом
   программировании вообще и квинах в частности; и [hirekoke](https://github.com/hirekoke)), или, лучше
   сказать, квин-полиглот (т.е. программа, написанная на одном языке, но при запуске выдающая программу
   на другом языке, в свою очередь печатающую программу на третьем, и т.д. пока последняя программа не
   напечатает снова самую первую), пробегающий при своей работе 128 языков (на начало 2020 года),
   в том числе и sed.
