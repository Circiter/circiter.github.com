...
Генератор (неэффективных) квинов для sed. Правда, сам генератор представляет собой набор как 
sed-скриптов, так и скриптов оболочки. Для генерации квинов используется доказательство второй 
рекурсивной теоремы Клини о неподвижных точках частично-рекурсивных функций. N.B., квины 
...
* [quine.sed](https://github.com/MakeNowJust/quine/blob/master/quine.sed) из
   ...
   не так-то и просто, но у его [автора](https://github.com/MakeNowJust), Tsuyusato Kitsune (см.
