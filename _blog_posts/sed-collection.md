...
* [quine.sed](https://github.com/MakeNowJust/quine/blob/master/quine.sed) из
   ...
   Kitsune (см. <http://quine.codes/>), богатый опыт в квайноводстве (им были написаны квайны 
   для более чем 260 (да, двухсот шестидесяти [или даже двухсот шестидесяти семи, кажется]) разных 
