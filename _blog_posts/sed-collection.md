...
* [quine.sed](https://github.com/MakeNowJust/quine/blob/master/quine.sed) из
   ...
   написать не так-то и просто, но у его [автора](https://github.com/MakeNowJust), Tsuyusato 
   Kitsune (см. <http://quine.codes/>), богатый опыт в квайноводстве (им были написаны квины для 
   более чем 260 (да, двухсот шестидесяти [или даже двухсот шестидесяти семи, кажется]) разных 
...
* <https://github.com/mame/quine-relay> -- <<итеративный>> 
   ...
   эзотерическом программировании вообще и квинах в частности; и 
   ...
   квин, пробегает при своей работе 128 языков (на начало 2020 года), в том числе и sed.
