...
* https://github.com/mame/quine-relay -- тоже квин (авторы: [Yusuke Endoh](https://github.com/mame),
   даже написавший [книжку](http://gihyo.jp/book/2015/978-4-7741-7643-7) об эзотерическом
   программировании и квинах в частности; hirekoke), точнее говоря, квин-полиглот (программа,
   написанная на одном языке, при запуске выдает программу на другом языке, в свою очередь печатающую
   программу на третьем, и т.д.), включающий в себя квины на 128 языках, в том числе и на sed.
