...
* [sushi.sed](https://gist.github.com/Circiter/b4fcf325a0de308771799bbd60208a31) -- попытка 
   ...
   культуры. Выглядит как осыпающийся набор типографских символов (в оригинале, модифицированных 
   японских, но здесь используется всего-лишь маленькое подмножество ASCII), оставляющих за 
   собой послесвечение как на старых ЭЛТ-мониторах или осциллографах.
   ...
   знакомым с SDR-техникой; в фильме этот инструмент применялся для <<обратной отладки>> -- 
   программы-хакеры, запущенные в эмуляторе, могли каким-то образом получать инженерный доступ к 
   недокументированным функциям эмулятора.)

   Скрипт `sushi.sed` написан в некотором смысле <<по-ошибке>>, но пригоден для демонстрации 
   генерации псевдослучайных чисел в редакторе sed.
...
* <https://github.com/jinchizhong/sed-snake> -- игра [<<змейка>>](https://en.wikipedia.org/wiki/Snake_(video_game_genre)); автор -- [Chizhong Jin](https://github.com/jinchizhong).
* <https://github.com/ValeriyKr/sfb> -- sed-реализация игры [<<flappy bird>>](https://en.wikipedia.org/wiki/Flappy_Bird); автор -- Валерий Киреев.
* <https://github.com/ValeriyKr/gravity-defied> -- ещё одна sed-игрушка, от [Вольдемара](https://github.com/Firemoon777).
