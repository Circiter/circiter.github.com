...
Поводом для написания этого скрипта явилось сообщение [kmkeen.com/awk-music] об этом способе
генерации звука. Но там был применен полноценный язык программирования `awk`, позволивший легко
получить более качественный чем у меня звук за счет использования треугольной формы сигнала. Так
появилась музыкальная программа-синтезатор на гораздо более ограниченном `sed`, именно в силу
ограниченности и представляющем больший спортивный интерес.
...
* [sliding-window.sed](https://gist.github.com/Circiter/77951d75b6b0e3b4ecc9b689e17863c3) -- другой
   ...
   текущей клетки выделяется 8-окрестность $3x3$, окрашивается, отображается. И так для всех клеток с их
...
Posix и смогло бы это решить проблему портабельности? Ближайший по смыслу найденный мною
...
* [http://sed.sourceforge.net/grabbag/scripts/sokoban.sed] -- широкоизвестная игра
   ![](/public/images/sokoban.png) (Sokoban, Сокобан); эта реализация интересна, разумеется, перемещением персонажа во всех
...
* [`quine.sed`](https://github.com/MakeNowJust/quine/blob/master/quine.sed) из
   ...
   не так-то и просто, но у его [автора](http://quine.codes/) богатый опыт в квинах (им были написаны
   квины для более чем 260 (да, двухсот шестидесяти [или даже двухсот шестидесяти семи, кажется])
