...
* https://github.com/mame/quine-relay -- тоже почти квин (авторы: [Yusuke Endoh](https://github.com/mame),
   ...
   программировании и квинах в частности; и [hirekoke](https://github.com/hirekoke)), или, лучше
   сказать, квин-полиглот (программа, написанная на одном языке, при запуске выдает программу на
   другом языке, в свою очередь печатающую программу на третьем, и т.д.), включающий в себя квины на
   128 языках, в том числе и на sed.
