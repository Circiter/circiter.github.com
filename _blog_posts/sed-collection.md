...
* [binary-multiplication.sed](https://gist.github.com/Circiter/042264eb9e9ee360d0eafa10eedf3f21)
   ...
   Алгоритм следует из двоичного разложения $y=\sum_i y_0 2^i,\ y_i\in\{0, 1\}$. Действительно, 
   $xy=x\sum_i y_i 2^i=\sum_I 2^ix$, где $I=\{i\colon y_i=1\}$. (Операция $y\gets\lfloor 
   y/2\rfloor$ на каждой итерации удаляет один самый младший бит числа $y$, т.о. сдвигая 
   двоичную запись числа: $y_0\gets y_1$.)
