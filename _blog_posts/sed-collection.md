...
* [`quine.sed`](https://github.com/MakeNowJust/quine/blob/master/quine.sed) из
   ...
   не так-то и просто, но у его [автора](https://github.com/MakeNowJust) (см. также
   [http://quine.codes/]) богатый опыт в квинах (им были написаны квины для более чем 260
