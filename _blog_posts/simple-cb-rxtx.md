...
test: true
tag: радиолюбительская-практика эксперименты приёмники передатчики гражданская-радиосвязь электронника
abstract: Описывается схемотехника, конструкция и функционирование простого экспериментального 
 радиопередатчика на одном транзисторе.
---
