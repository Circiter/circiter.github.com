...
[4] и возвращающий её в том же формате, что и `computus.sed`. Он может использоваться для
сравнительного тестирования моего скрипта, а с целью упрощения этой процедуры для диапазонов
дат, можно воспользоваться сценарием оболочки `range-test.sh`.
