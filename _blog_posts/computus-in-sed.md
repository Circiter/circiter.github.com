...
Но, оказывается, должна учитываться и конкретная дата внутри века, причем не самым систематичным
...
православная церковь просто использует фиксированную разницу в 13 дней всегда.

В любом случае, несмотря на то, что `Dates::Easter` учитывает вековое варьирование разницы между
