...
слово *текст*, иногда даже *исходный код*, без прямого отсыла к понятию *нумерации* из теории 
вычислимости. Более того, вразрез с традиционным словоупотреблением, в настоящем сообщении 
нередко программа и её текст будут отождествляться, -- здесь это просто одно и то же. (Краткости 
