...
функцией $\llbracket p\rrbracket\colon p\mapsto D^D$, сопоставляющей программе $p$ функцию $D\to D$, где $D$ -- множество, над которым определены вычислимые функции (в большинстве случаев можно 
