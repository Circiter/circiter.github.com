...
Случай $n=1$ соответствует обычным квайнам и уже доказан. Для $n>1$ положим $q_i = 
\operatorname{quote} q_j$, где $j\equiv i+1\pmod n$. Тогда $\llbracket q_i\rrbracket = 
q_{i+1\bmod n}$. $\blacksquare$

Всякий, кто пытался писать квайны и цепные квайны, не мог не отметить разительное отличие в 
сложности их написания (и это объясняется только что приведенной небольшой теоремой) -- цепные 
квайны [при $n>1$] обычно проще истинных квайнов (i.e., тоже цепных квайнов, но с периодом 
$n=1$).
