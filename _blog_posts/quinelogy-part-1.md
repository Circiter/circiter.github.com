...
функцией $\llbracket\cdot\rrbracket\colon D\to D$, где $D$ -- множество, над которым определены 
...
образом $N_{xy}$ (причем отображение $(x, y)\mapsto N_{xy}$ вычислимо). Это позволяет 
определять 
