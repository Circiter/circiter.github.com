...
Сами квайны при этом появились раньше. Может быть их историю следовало бы вести с 
<<докомпьютерной>> эры, а именно с работ фон Неймана по самореплицирующимся [клеточным] 
автоматам [9, 48] или даже с работ Черча и Хаскеля...
...
(При работе с функциями многих аргументов предполагается, что кортеж аргументов выражается через 
...
$\operatorname{quote}$, определенный в разделе о теореме Роджерса (см. выше). Этот оператор 
преобразует программу $p$ в программу, печатающую текст $p$, а по только что изложенной первой 
...
Следующий куин исправляет этот недостаток (автор Dan Hoey: hoey@aic.nrl.navy.mil):
...
Куины: www.nyx.net/~gthompso/quine.htm
